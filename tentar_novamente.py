...
def verificar_tamanho(event):
    ...
    if len (tamanho) > 2:
        ...
        botao_tentar_novamente = tk.Button(janela,text="Clique para tentar novamente", bg='blue', fg='white')
        botao_tentar_novamente.pack()
        botao_sair = tk.Button(janela, text="Clique para sair",bg='red', fg='white')
        botao_sair.pack()
